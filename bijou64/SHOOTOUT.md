...
> Criterion benchmarks comparing bijou64 against varu64, vu64, vu128, and leb128. All times are median µs over 4096 values. Asterisk (\*) marks the fastest in each row.
>
...
| Distribution     | bijou64    | varu64 | vu64        | vu128 | leb128      |
|------------------|------------|--------|-------------|-------|-------------|
| tiny (0--247)    | **2.31\*** | 11.28  | 20.93       | 16.88 | 4.38        |
| small (248--64k) | **7.52\*** | 20.10  | 22.92       | 20.16 | 11.46       |
| medium (64k--4B) | 19.13      | 26.32  | 22.27       | 21.59 | **13.40\*** |
| large (>4B)      | 12.83      | 27.55  | **11.08\*** | 11.47 | 32.34       |
| tier boundaries  | 15.88      | 28.99  | 18.37       | 18.43 | **11.48\*** |
| uniform random   | 12.68      | 27.63  | **11.09\*** | 11.50 | 32.69       |

## Encode Array

Encode to a fixed `[u8; 9]` with no allocation. leb128 is excluded because its API requires a `Write` implementor.

| Distribution     | bijou64    | varu64 | vu64       | vu128 |
|------------------|------------|--------|------------|-------|
| tiny (0--247)    | **1.30\*** | 5.15   | 1.66       | 2.97  |
| small (248--64k) | **2.53\*** | 8.73   | 1.65       | 3.58  |
| medium (64k--4B) | 2.50       | 12.49  | **1.64\*** | 3.55  |
| large (>4B)      | 2.71       | 19.82  | **1.64\*** | 3.49  |
| tier boundaries  | 2.50       | 16.94  | **1.64\*** | 3.35  |
| uniform random   | 2.49       | 20.27  | **1.64\*** | 3.49  |
...
| large (>4B)      | 10.14       | 22.47  | 8.87  | **8.76\*** | 36.42  |
| tier boundaries  | **10.26\*** | 19.51  | 12.44 | 10.26      | 15.75  |
| uniform random   | 10.08       | 22.54  | 8.90  | **8.82\*** | 35.93  |
...
Bold with asterisk (\*) marks the smallest encoding in each row. Three patterns emerge:
...
| Distribution     | bijou64 | varu64 | vu64   | vu128      | leb128 |
|------------------|---------|--------|--------|------------|--------|
| tiny (0--247)    | 7.38    | 10.07  | 22.58  | **5.00\*** | 15.73  |
| small (248--64k) | 15.77   | 17.51  | 26.36  | **7.06\*** | 22.61  |
| medium (64k--4B) | 17.51   | 27.46  | 21.96  | **2.78\*** | 26.39  |
| large (>4B)      | 24.17   | 42.15  | 11.88  | **2.54\*** | 58.49  |
| tier boundaries  | 22.63   | 35.07  | 17.62  | **4.28\*** | 24.70  |
| uniform random   | 24.08   | 41.48  | 11.51  | **2.58\*** | 57.20  |
