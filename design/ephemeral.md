...
| Concept                              | File                                                       |
|--------------------------------------|------------------------------------------------------------|
| Handler trait impl                   | [`subduction_ephemeral/src/handler.rs`]                    |
| Publish entry point                  | [`EphemeralHandler::publish`]                              |
| Recv entry point                     | [`EphemeralHandler::recv_ephemeral`]                       |
| Nonce cache                          | [`subduction_ephemeral/src/nonce_cache.rs`]                |
| Wire encode/decode                   | [`subduction_ephemeral/src/message.rs`]                    |
| Policy trait                         | [`subduction_ephemeral/src/policy.rs`]                     |
| Topic newtype                        | [`subduction_ephemeral/src/topic.rs`]                      |
| Composed handler (sync + ephemeral)  | [`subduction_ephemeral/src/composed.rs`]                   |
| Tests: handler unit                  | [`tests/ephemeral_handler.rs`]                             |
| Tests: amplification regression      | [`tests/amplification.rs`]                                 |
| Tests: codec proptests               | [`tests/codec_proptest.rs`]                                |
| Tests: composed handler              | [`tests/composed_handler.rs`]                              |

[`subduction_ephemeral/src/handler.rs`]: ../subduction_ephemeral/src/handler.rs
[`EphemeralHandler::publish`]: ../subduction_ephemeral/src/handler.rs
[`EphemeralHandler::recv_ephemeral`]: ../subduction_ephemeral/src/handler.rs
[`subduction_ephemeral/src/nonce_cache.rs`]: ../subduction_ephemeral/src/nonce_cache.rs
[`subduction_ephemeral/src/message.rs`]: ../subduction_ephemeral/src/message.rs
[`subduction_ephemeral/src/policy.rs`]: ../subduction_ephemeral/src/policy.rs
[`subduction_ephemeral/src/topic.rs`]: ../subduction_ephemeral/src/topic.rs
[`subduction_ephemeral/src/composed.rs`]: ../subduction_ephemeral/src/composed.rs
[`tests/ephemeral_handler.rs`]: ../subduction_ephemeral/tests/ephemeral_handler.rs
[`tests/amplification.rs`]: ../subduction_ephemeral/tests/amplification.rs
[`tests/codec_proptest.rs`]: ../subduction_ephemeral/tests/codec_proptest.rs
[`tests/composed_handler.rs`]: ../subduction_ephemeral/tests/composed_handler.rs
