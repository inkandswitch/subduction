...
//
// The "slim" package is a subpath export of the "@automerge/subduction"
...
console.log("=========================================");
// Also base64 encode the wasm file and write it to pkg-slim/sedimentree_automerge_wasm_bg.wasm.base64
const wasmFile = path.join(SLIM_PKG_DIR, "sedimentree_automerge_wasm_bg.wasm");
const base64File = path.join(SLIM_PKG_DIR, "sedimentree_automerge_wasm_bg.wasm.base64.js");
...
const typesFile = path.join(SLIM_PKG_DIR, "sedimentree_automerge_wasm_bg.wasm.base64.d.ts");
const typesContents = `
  declare module "sedimentree_automerge_wasm_bg.wasm" {
